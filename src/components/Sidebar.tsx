    ...
    <aside className={`sidebar ${isCollapsed ? 'sidebar-collapsed' : ''}`}>
      ...
      <nav className="sidebar-nav">
        <button
          ...
          title="Dashboards"
        >
          <span className="sidebar-icon"><img src="/icons/icon-dashboard.png" alt="" width="28" height="28" /></span>
          {!isCollapsed && (
            <>
        ...
        <button
          ...
          title="OKR List"
        >
          <span className="sidebar-icon"><img src="/icons/icon-list.png" alt="" width="28" height="28" /></span>
        ...
        <button
          ...
          title="OKR Map"
        >
          <span className="sidebar-icon"><img src="/icons/icon-map.png" alt="" width="28" height="28" /></span>
        ...
        <button
          ...
          title="Users"
        >
          <span className="sidebar-icon"><img src="/icons/icon-user.png" alt="" width="28" height="28" /></span>
          {!isCollapsed && (
            <>
